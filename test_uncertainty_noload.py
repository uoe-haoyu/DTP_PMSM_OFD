...
if __name__ == '__main__':
    ...
    os.makedirs('Uncertainty_results/Proposed/20/', exist_ok=True)
    save_path = r'Uncertainty_results/Proposed/20/'  # save predicted results
   ...
   #  netname = model_repo.MLP
    ...
    tester = test_uncertainty.Test(config)
    accuracys = []
    for i in range(1):
